        ...
        return (
            <div className="quiz-container">
                ...
                {!quizResult ? (
                    ...
                    <div className="quiz-result" style={{marginTop: '20px', padding: '15px', backgroundColor: '#e8f5e9', borderRadius: '5px'}}>
                        <h3>You scored {quizResult.score} / {quizResult.total} ({quizResult.percentage.toFixed(0)}%)</h3>
                    </div>
                )}
            </div>
        );
