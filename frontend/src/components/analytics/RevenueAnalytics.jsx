...
import { fetchRevenueAnalytics } from '../../store'; // Adjust path if needed
...
const RevenueAnalytics = () => {
    ...
    const { revenueData = [], loading } = useSelector(state => state.analytics);
    ...
    }, [revenueData, dateFrom, dateTo, revenueGranularity]);
