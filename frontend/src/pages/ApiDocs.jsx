...
import { API_DOCS_URL } from "../utils/env";
          ...
          <div className="p-6">
            <div className="mb-6">
              ...
              <p className="text-gray-600 mb-4">
                Access the complete Swagger API documentation with interactive
              ...
              <div className="overflow-x-auto">
                <table className="min-w-full table-auto border-collapse border border-gray-300">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td className="border border-gray-300 px-4 py-2 font-mono text-sm bg-green-50">
                        POST
                      </td>
                    ...
                    <tr className="bg-gray-50">
                      <td className="border border-gray-300 px-4 py-2 font-mono text-sm bg-red-50">
                        POST
                      </td>
                      <td className="border border-gray-300 px-4 py-2 font-mono text-sm">
                        /api/auth/logout
                    ...
                    <tr>
                      <td className="border border-gray-300 px-4 py-2 font-mono text-sm bg-blue-50">
                        GET
                      </td>
                      <td className="border border-gray-300 px-4 py-2 font-mono text-sm">
                        /api/auth/me
                    ...
                    <tr className="bg-gray-50">
                      <td className="border border-gray-300 px-4 py-2 font-mono text-sm bg-yellow-50">
                        PUT
                      </td>
                      <td className="border border-gray-300 px-4 py-2 font-mono text-sm">
                        /api/auth/profile
                    ...
                    <tr>
                      ...
                      <td className="border border-gray-300 px-4 py-2">
                        Get instructor performance rankings
                      </td>
                    </tr>
                    <tr className="bg-gray-50">
                      <td className="border border-gray-300 px-4 py-2 font-mono text-sm bg-blue-50">
                    ...
                    <tr className="bg-gray-50">
                      ...
                      <td className="border border-gray-300 px-4 py-2">
                        Get review status of instructor's courses
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-gray-300 px-4 py-2 font-mono text-sm bg-green-50">
                      ...
                      <td className="border border-gray-300 px-4 py-2">
                        Add note to course under review
                      </td>
                    </tr>
                    <tr className="bg-gray-50">
                      <td className="border border-gray-300 px-4 py-2 font-mono text-sm bg-blue-50">
                    ...
                    <table className="min-w-full table-auto border-collapse border border-gray-300">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td className="border border-gray-300 px-4 py-2">
                            Student learning dashboard with enrolled courses
                          </td>
                        </tr>
                        <tr className="bg-gray-50">
                          <td className="border border-gray-300 px-4 py-2 font-mono text-sm">
                        ...
                        <tr className="bg-gray-50">
                          ...
                          <td className="border border-gray-300 px-4 py-2">
                            Course review and approval dashboard
                          </td>
                        </tr>
                        <tr>
                          <td className="border border-gray-300 px-4 py-2 font-mono text-sm">
                        ...
                        <tr className="bg-gray-50">
                          ...
                          <td className="border border-gray-300 px-4 py-2">
                            Edit existing course interface
                          </td>
                        </tr>
                        <tr>
                          <td className="border border-gray-300 px-4 py-2 font-mono text-sm">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="border rounded-lg p-4">
                      ...
                      <p className="text-sm text-gray-600">
                        Route guard component that checks user authentication
                    ...
                    <div className="border rounded-lg p-4">
                      ...
                      <p className="text-sm text-gray-600">
                        Real-time chat component for course discussions using
                        Socket.IO.
                      </p>
                    </div>
                    ...
                    <div className="border rounded-lg p-4">
                      ...
                      <p className="text-sm text-gray-600">
                        Comprehensive analytics components for instructors and
                        administrators.
                      </p>
                    </div>
                    ...
                    <div className="border rounded-lg p-4">
                      ...
                      <p className="text-sm text-gray-600">
                        Interactive quiz creation and editing component for
                        instructors.
                      </p>
                    </div>
                    ...
                    <div className="border rounded-lg p-4">
                      ...
                      <p className="text-sm text-gray-600">
                        Gamified learning components to enhance student
                        engagement.
                      </p>
                    </div>
