...
const getCourseCompletionPercentage = (course) => {
  // Prefer backend-provided accurate counts when available
  const completed =
    ...
    <>
      <div className="dashboard-intro">
        ...
        <p className="text-gray-600">
          Welcome back, {user?.name}. You are enrolled in {enrolledCount}{" "}
          courses.
        </p>
      </div>
      ...
      <section className="course-section course-list-area-60-percent">
        ...
        {loading ? (
          <div className="loading-state-full">
            <Loader2 className="animate-spin" size={32} /> Loading your enrolled
            courses...
          </div>
          ...
          <div className="course-grid student-course-grid">
            {enrolledList.map((course) => {
              ...
              // Coerce backend-provided values to numbers if possible
              ...
              const totalModulesDisplay = !isNaN(Number(backendTotal))
                ? Number(backendTotal)
                : course.modules_status?.length > 0
                  ? course.modules_status.length
                  : "?";

              const completionPercent = getCourseCompletionPercentage(course);
              const progressBarColor =
                course.completionStatus === "completed" ? "#10b981" : "#3b82f6"; // Use actual status for color

              return (
                <div
                  key={course._id}
                  className="course-card horizontal-progress-card"
                >
                  ...
                  <div className="card-content-wrapper">
                    <div className="course-card-header">
                      ...
                      <span
                        ...
                        style={{ color: progressBarColor, fontWeight: "bold" }}
                      >
                  ...
                  <div className="progress-action-wrapper">
                    ...
                    <div className="course-progress-container">
                      <span className="progress-text-card">
                        ...
                        Progress: {completedCount}/{totalModulesDisplay} Modules
                        Watched ({completionPercent.toFixed(0)}%)
                      </span>
